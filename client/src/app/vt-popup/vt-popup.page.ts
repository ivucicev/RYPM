...
import { LoadingController, ModalController, NavController, ToastController, IonContent, IonCard, IonList, IonItem, IonButton, IonIcon } from '@ionic/angular/standalone';
...
export class VtPopupPage implements OnInit {
  ...
  onSubscribe() {
    ...
    let req = {
      "email": this.email_Id,
      "source": "opus_application_fitworld"
    }
